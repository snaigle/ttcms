create table if not exists news(id int primary key auto_increment,content_type varchar(20),mk_content varchar(20000000),title varchar(2000),content  varchar(20000000),create_time timestamp);
